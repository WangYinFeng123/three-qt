...
void osgEarth::QtGui::DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::mapChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DataManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::selectionChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (DataManager::*)(osgEarth::Annotation::AnnotationNode * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::annotationAdded)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (DataManager::*)(osgEarth::Annotation::AnnotationNode * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::annotationRemoved)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject osgEarth::QtGui::DataManager::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_osgEarth__QtGui__DataManager.data,
    qt_meta_data_osgEarth__QtGui__DataManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *osgEarth::QtGui::DataManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "osg::Referenced"))
        return static_cast< osg::Referenced*>(this);
    if (!strcmp(_clname, "ActionManager"))
        return static_cast< ActionManager*>(this);
