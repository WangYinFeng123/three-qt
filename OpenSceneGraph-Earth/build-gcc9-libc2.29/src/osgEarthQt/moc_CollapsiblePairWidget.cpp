...
void osgEarth::QtGui::CollapsiblePairWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CollapsiblePairWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject osgEarth::QtGui::CollapsiblePairWidget::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_osgEarth__QtGui__CollapsiblePairWidget.data,
    qt_meta_data_osgEarth__QtGui__CollapsiblePairWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
