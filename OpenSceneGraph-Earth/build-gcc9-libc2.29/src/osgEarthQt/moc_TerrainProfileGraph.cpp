...
void osgEarth::QtGui::TerrainProfileGraph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TerrainProfileGraph *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TerrainProfileGraph::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TerrainProfileGraph::onNotifyTerrainGraphChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject osgEarth::QtGui::TerrainProfileGraph::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_osgEarth__QtGui__TerrainProfileGraph.data,
    qt_meta_data_osgEarth__QtGui__TerrainProfileGraph,
    qt_static_metacall,
    nullptr,
    nullptr
} };
