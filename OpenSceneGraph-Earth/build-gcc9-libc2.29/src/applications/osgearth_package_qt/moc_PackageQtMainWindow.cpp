...
void PackageQt::PackageQtMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PackageQtMainWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PackageQt::PackageQtMainWindow::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_PackageQt__PackageQtMainWindow.data,
    qt_meta_data_PackageQt__PackageQtMainWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
