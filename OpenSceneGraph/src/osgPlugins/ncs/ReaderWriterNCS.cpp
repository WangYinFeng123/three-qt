...
class ReaderWriterNCS : public osgDB::ReaderWriter
{
public:
    ReaderWriterNCS()
    {
        supportsExtension( "ncs", "OpenSceneGraph extendable binary format" );
    ...
    virtual WriteResult writeNode( const osg::Node& node, const std::string& fileName, const Options* options ) const
    {
        ...
        std::stringstream ss;
        result = writeNode( node, ss, local_opt.get() );
...
REGISTER_OSGPLUGIN( ncs, ReaderWriterNCS )
